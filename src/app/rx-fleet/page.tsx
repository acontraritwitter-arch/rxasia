    ...
    <main id="main">
      ...
      {modules.map((module, moduleIndex) => (
        <section
          ...
          className={cn(
            sectionPad,
            moduleIndex % 2 === 0 ? "bg-gray-50 dark:bg-[#0a0510]" : undefined,
          )}
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <Reveal className={sectionHeadGap}>
      ...
      <section className={sectionPad}>
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="text-display-md font-semibold text-gray-900 dark:text-white">{cta.title}</h2>
            <p className="mt-4 text-base font-normal leading-relaxed text-gray-600 dark:text-gray-300">
              {cta.body}
            </p>
